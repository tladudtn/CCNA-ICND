...
- 표준화된 접속규격
  - 계층간 표준화된 접속 규격 정의를 통하여, 공정한 경쟁의 장점을 가지고,</br>다수의 장비 제조업체들이 특별한 기능을 만족하는 제품들을 생산하는 것이 가능해진다.
- 학습의 편의성
  - 많은 프로토콜의 명세에 대하여 쉽게 논의하고 배울 수 있다.
- 개발의 편의성
  - 줄어든 복잡성으로쉽게 프로그램 수정 및 빠른 제품 개발이 가능하다
- 다수 제조업체의 편의성
  - 동일한 네트워킹 표준을 만족하는 제품을 제작하는것은,</br>다수의 벤더 컴퓨터와 네트워킹 장비가 동일한 네트워크에서 동작하는것을 의미한다.
- 모듈식 엔지니어링
  - 하나의 벤더는 상위 계층의 웹 브라우저와 같은 소프트웨어를 작성하고,</br>다른 벤더는 마이크로 소프트 운영체제 내장 TCP/IP 소프트웨어 같은 하위 계층을 구현하는 소프트웨어를 작성할 수 있다.
